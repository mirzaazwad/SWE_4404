...
const {getMessages,addMessage,getAllSenders,countUnread,countUnreadReceiver, countAllUnreadReceiver,toggleRead, countAllUnread,toggleReadReceiver} = require('../controller/chat');
