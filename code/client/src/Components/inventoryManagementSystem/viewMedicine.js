...
const ViewMedicine = () => {
  ...
  const handleFilterValueChange = (event) => {
    ...
    setFilteredMedicines(medicines.filter(medicine => medicine[filterOption].toLowerCase().includes(value.toLowerCase())));
  }
  ...
  return ( <
    ...
    tbody > {
      filteredMedicines.map((medicine) => ( <
        ...
        className = "mx-0 plusButton" > <i class='bx bxs-plus-circle plusIcon' style={{fontSize:'24px'}}></i>< /Button> <
        Button variant = "danger"
        className = "mx-0 minusButton" > <i class='bx bxs-minus-circle minusIcon' style={{fontSize:'24px'}}></i> < /Button> <
        /td> <
        /tr>
      ))
    } <
